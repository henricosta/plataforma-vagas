...
const deleteUser = () => {
    form.delete(route('empresa.destroy'), {
        preserveScroll: true,
        ...
        <Modal :show="confirmingEmpresaDeletion" @close="closeModal">
            <div class="p-6">
                <h2 class="text-lg font-medium text-gray-900">
                    Tem certeza que quer deletar sua empresa?
                </h2>

                <p class="mt-1 text-sm text-gray-600">
                    Insira sua senha para confirmar que você gostaria de apagar permanentemente a sua conta.
                </p>
